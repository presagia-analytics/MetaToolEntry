...
get_trail_outcome_in <- function(trial_con_db, outcome_type){
...
get_trail_outcome <- function(trial_con_db){
  out_db <- rbind(
    get_trail_outcome_in(trial_con_db, "continuous"),
    get_trail_outcome_in(trial_con_db, "categorical"),
    get_trail_outcome_in(trial_con_db, "survival")) %>%
    distinct() %>%
    group_by(trial_id) %>% 
